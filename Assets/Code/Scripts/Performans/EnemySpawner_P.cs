...
public class EnemySpawner_P : MonoBehaviour
{
    ...
    private IEnumerator DalgaYoneticisi()
    {
        while (mevcutDalga <= toplamDalga)
        {
            ...
            UIManager.main.DalgaDurumunuGuncelle(true, mevcutDalga); // Dalga baþlangýcýný UI'ya bildir
    ...
    private void DusmanOlustur()
    {
        ...
        int koridorIndeksi = Random.Range(0, LevelManager_P.anaYonetic.koridorlar.Length);
        var koridor = LevelManager_P.anaYonetic.koridorlar[koridorIndeksi];
