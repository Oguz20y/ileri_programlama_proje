...
public class EnemySpawner : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            DalgaBitir();
            UIManager.main.DalgaDurumunuGuncelle(false, guncelDalga); // Dalga bitiþini bildir
        }
    }
    ...
    private IEnumerator DalgaBaslat()
    {
        ...
        UIManager.main.DalgaDurumunuGuncelle(true, guncelDalga); // Dalga baþlangýcýný bildir
    ...
    private void DalgaBitir()
    {
        ...
        {
            dalgaBitti = true;
            UIManager.main.DalgaDurumunuGuncelle(false, guncelDalga); // Son dalga olduðu için bildir
            return;
        }
